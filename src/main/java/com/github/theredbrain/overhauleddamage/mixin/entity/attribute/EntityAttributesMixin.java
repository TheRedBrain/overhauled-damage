...
public class EntityAttributesMixin {
	static {
		...
		OverhauledDamage.BLEEDING_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerReference(Registries.ATTRIBUTE, OverhauledDamage.identifier("generic.bleeding_build_up_reduction_delay_threshold"), new ClampedEntityAttribute("attribute.name.generic.bleeding_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setTracked(true));
		...
		OverhauledDamage.FREEZE_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerReference(Registries.ATTRIBUTE, OverhauledDamage.identifier("generic.freeze_build_up_reduction_delay_threshold"), new ClampedEntityAttribute("attribute.name.generic.freeze_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setTracked(true));
		...
		OverhauledDamage.BURN_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerReference(Registries.ATTRIBUTE, OverhauledDamage.identifier("generic.burn_build_up_reduction_delay_threshold"), new ClampedEntityAttribute("attribute.name.generic.burn_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setTracked(true));
		...
		OverhauledDamage.SHOCK_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerReference(Registries.ATTRIBUTE, OverhauledDamage.identifier("generic.shock_build_up_reduction_delay_threshold"), new ClampedEntityAttribute("attribute.name.generic.shock_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setTracked(true));
		...
		OverhauledDamage.POISON_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerReference(Registries.ATTRIBUTE, OverhauledDamage.identifier("generic.poison_build_up_reduction_delay_threshold"), new ClampedEntityAttribute("attribute.name.generic.poison_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setTracked(true));
		...
		OverhauledDamage.STAGGER_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerReference(Registries.ATTRIBUTE, OverhauledDamage.identifier("generic.stagger_build_up_reduction_delay_threshold"), new ClampedEntityAttribute("attribute.name.generic.stagger_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setTracked(true));

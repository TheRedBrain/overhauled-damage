...
public class AttributesMixin {
	static {
		...
		OverhauledDamage.BLEEDING_DURATION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("bleeding_duration"), new RangedAttribute("attribute.name.bleeding_duration", 201.0, 1.0, 1000000.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.BLEEDING_TICK_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("bleeding_tick_threshold"), new RangedAttribute("attribute.name.bleeding_tick_threshold", 20.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.BLEEDING_BUILD_UP_REDUCTION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("bleeding_build_up_reduction"), new RangedAttribute("attribute.name.bleeding_build_up_reduction", 1.0, -1024.0, 1024.0).setSyncable(true));
		OverhauledDamage.BLEEDING_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("bleeding_build_up_reduction_delay_threshold"), new RangedAttribute("attribute.name.bleeding_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		...
		OverhauledDamage.FREEZE_DURATION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("freeze_duration"), new RangedAttribute("attribute.name.freeze_duration", 200.0, 1.0, 1000000.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.FREEZE_TICK_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("freeze_tick_threshold"), new RangedAttribute("attribute.name.freeze_tick_threshold", 20.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.FREEZE_BUILD_UP_REDUCTION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("freeze_build_up_reduction"), new RangedAttribute("attribute.name.freeze_build_up_reduction", 1.0, -1024.0, 1024.0).setSyncable(true));
		OverhauledDamage.FREEZE_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("freeze_build_up_reduction_delay_threshold"), new RangedAttribute("attribute.name.freeze_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		...
		OverhauledDamage.BURN_DURATION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("burn_duration"), new RangedAttribute("attribute.name.burn_duration", 351.0, 1.0, 1000000.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.BURN_TICK_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("burn_tick_threshold"), new RangedAttribute("attribute.name.burn_tick_threshold", 20.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.BURN_BUILD_UP_REDUCTION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("burn_build_up_reduction"), new RangedAttribute("attribute.name.burn_build_up_reduction", 1.0, -1024.0, 1024.0).setSyncable(true));
		OverhauledDamage.BURN_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("burn_build_up_reduction_delay_threshold"), new RangedAttribute("attribute.name.burn_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		...
		OverhauledDamage.SHOCK_DURATION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("shock_duration"), new RangedAttribute("attribute.name.shock_duration", 1.0, 1.0, 1000000.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.SHOCK_TICK_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("shock_tick_threshold"), new RangedAttribute("attribute.name.shock_tick_threshold", 20.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.SHOCK_BUILD_UP_REDUCTION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("shock_build_up_reduction"), new RangedAttribute("attribute.name.shock_build_up_reduction", 1.0, -1024.0, 1024.0).setSyncable(true));
		OverhauledDamage.SHOCK_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("shock_build_up_reduction_delay_threshold"), new RangedAttribute("attribute.name.shock_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		...
		OverhauledDamage.POISON_DURATION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("poison_duration"), new RangedAttribute("attribute.name.poison_duration", 201.0, 1.0, 1000000.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.POISON_TICK_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("poison_tick_threshold"), new RangedAttribute("attribute.name.poison_tick_threshold", 20.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.POISON_BUILD_UP_REDUCTION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("poison_build_up_reduction"), new RangedAttribute("attribute.name.poison_build_up_reduction", 1.0, -1024.0, 1024.0).setSyncable(true));
		OverhauledDamage.POISON_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("poison_build_up_reduction_delay_threshold"), new RangedAttribute("attribute.name.poison_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		...
		OverhauledDamage.STAGGER_DURATION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("stagger_duration"), new RangedAttribute("attribute.name.stagger_duration", 200.0, 1.0, 1000000.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.STAGGER_TICK_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("stagger_tick_threshold"), new RangedAttribute("attribute.name.stagger_tick_threshold", 20.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
		OverhauledDamage.STAGGER_BUILD_UP_REDUCTION = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("stagger_build_up_reduction"), new RangedAttribute("attribute.name.stagger_build_up_reduction", 1.0, -1024.0, 1024.0).setSyncable(true));
		OverhauledDamage.STAGGER_BUILD_UP_REDUCTION_DELAY_THRESHOLD = Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, OverhauledDamage.identifier("stagger_build_up_reduction_delay_threshold"), new RangedAttribute("attribute.name.stagger_build_up_reduction_delay_threshold", 40.0, 0.0, 1024.0).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
